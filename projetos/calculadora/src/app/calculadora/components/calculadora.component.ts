...
export class CalculadoraComponent implements OnInit {
  ...
  /**
   * retorna o valor concatenado treta o separador decimal
   *
  ...
  /**
   * Executa logica quando um oprador for selecionado
   * Caso ja possua uma operação selecionada executa a
   * operação anterior, e define a nova operção
   *
  ...
  definirOperacao(operacao: string): void {
    ...
    //Caso operação definida e numero 2 selecionado, efetua o calculo da operacao
